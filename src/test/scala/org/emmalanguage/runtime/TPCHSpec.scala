...
class TPCHSpec extends FreeSpec with Matchers with CoGaDBSpec {
  ...
  override val startupFile = Paths.get(tempPath(s"/cogadb/tpch.coga"))

  override def beforeAll(): Unit = {
    super.beforeAll()
    materializeResource(s"/cogadb/tpch.coga")
  }
  ...
  "TPCH-01" ignore withCoGaDB { implicit cogadb: CoGaDB =>
  ...
  "TPCH-03" ignore withCoGaDB { implicit cogadb: CoGaDB =>
  ...
  "TPCH-06" ignore withCoGaDB { implicit cogadb: CoGaDB =>
